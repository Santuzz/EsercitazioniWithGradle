package objectoriented.library;
...
class LibraryTest {
    @Test
    void getLongestRent() throws ParseException {
        ...
        assertEquals(i1, l.getLongestRent().getItem());
        assertEquals(s1, l.getLongestRent().getStudent());
        assertEquals(sdf.parse("25/08/2020"), l.getLongestRent().getBegin());
        assertEquals(sdf.parse("14/11/2020"), l.getLongestRent().getEnd());
    }
}